	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float3 linearToGamma5 = FastLinearToSRGB( tex2D( _MainTex, uv_MainTex ).rgb );
				
				float4 Color = float4( linearToGamma5 , 0.0 );
...
/*ASEBEGIN
Version=18935
2560;307;2372;1003;1621;496.5;1;True;False
Node;AmplifyShaderEditor.SamplerNode;4;-890,-124.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LinearToGammaNode;5;-431,-97.5;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
