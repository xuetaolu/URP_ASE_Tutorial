Shader "genship/postprocessfog_box_v3_backup_moon_affect"
{
    Properties
    {
        ...
        _FogColorB ("_FogColorB", Color) = (0,0,0,0)
        _64__m17 ("_64__m17", Vector) = (1.00, -1.00, 10000.00, 0.00)
    }
    SubShader
    {
...
//            Cull Off
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                if (0.01 < _MoonPos_maybe.w)
                {
                    ...
                    // #define _64__m20 float4(0.00, 0.00, 0.00, 0.00               ) //_64._m20
                    // _26 = _64__m20.x >= 0.05;
                    // _24.x = float(0.05 <= _64__m20.x);
                    // _24.x *= _31.x;
                    // // _29 = 0.95 >= _64__m20.x;
                    // _27.x = float(_64__m20.x <= 0.95);
                    // _27.x *= _31.x;
                    // _if_output1 = _24.x;
                    // _if_output2 = _27.x;
                    _if_output1 = float(0.05 <= _64__m20.x) * _31.x;
                    _if_output2 = float(_64__m20.x <= 0.95) * _31.x;
                }
                else
                {
                    _if_output1 = 0.0;
                ...
                // return 
                // return color;
                // return float4(_if_output1, _if_output2,0.5,1);
                // return value;
