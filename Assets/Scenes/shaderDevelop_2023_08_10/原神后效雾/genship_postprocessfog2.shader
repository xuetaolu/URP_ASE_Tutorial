Shader "genship/postprocessfog2"
{
    Properties
    {
//        _7 ("_7", 2D) = "white" {}
        ...
        _FogGradientFactorZ_ ("_FogGradientFactorZ_", Vector) = (0.00839, -0.12581, 1.00, 1.00)
        /*_m6 变xyz */ _FogDistanceColor ("_FogDistanceColor", Color) = (0.05654, 0.13585, 0.35222, 0.92)
        /*_m7 变xyz */ _SkyFogDistanceScaleW_ ("_SkyFogDistanceScaleW_", Vector) = (-0.00127, 0.0048, -0.13633, 0.00)
        /*_m8 变xy  */ _TerrainYSO_XY_TerrainDistanceSO_ZW_ ("_TerrainYSO_XY_TerrainDistanceSO_ZW_", Vector) = (0.00147, -0.26394, 0.00047, -0.00707)
        /*_m9 变xyz */ _FogColorC ("_FogColorC", Color) = (0.46001, 0.42273, 0.46656, 0.00017)
        /*_m10变w   */ _64__m10 ("_64__m10", Vector) = (-0.00033, 2.44722, -0.001, 1.17958)
        _FogColorXYZ ("_FogColorXYZ", Color) = (0.32624, 0.22609, 0.19079, 15.00)
        _FogVisibleDistanceW ("_FogVisibleDistanceW", Range(0, 32)) = 15.00
        _TerrainDistanceXYSO_ZW_DistanceSO_XY_ ("_TerrainDistanceXYSO_ZW_DistanceSO_XY_", Vector) = (0.002, 0.00, -0.0005, 1.07681)
        /*_m13变xy  */ _ExpDampingStartXZ_ ("_ExpDampingStartXZ_", Vector) = (0.12955, -2.04365, 0.03779, -3.27578)
        _FogDistanceLimitX_Y_ ("_FogDistanceLimitX_Y_", Vector) = (1.00, 1.00, 0.00, 0.00)
        
        _64__m20 ("_64__m20", Vector) = (0.00, 0.00, 0.00, 0.00)
        _ColorA2 ("_ColorA2", Color) = (1.00, 1.00, 1.00, 0.07213)
        _MoonPos_maybe_Pos ("_MoonPos_maybe_Pos", Vector) = (89.90182, 0.00, 656.74915)
        _MoonPos_maybe_W ("_MoonPos_maybe_W", Range(0, 1)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.Varying_ScreenPos = _screenPos;
            ...
            #define _64__m18 float4(1.00, 1.00, 1.00, -15.00             ) //_64._m18
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // _terrainWorldPos = ReconstructWorldPositionFromDepth( _screenPos01, _rawDepth );
