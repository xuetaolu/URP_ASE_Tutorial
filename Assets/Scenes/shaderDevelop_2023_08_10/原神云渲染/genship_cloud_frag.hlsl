...
fixed4 frag (v2f i) : SV_Target
{
    ...
    _27.x *= _27.x;
    _27.x *= _39.x;
    float2 _128 = float2(i.Varying_2.y + i.Varying_2.w, i.Varying_2.z + i.Varying_2.w);
    _39 = float3(_128.x, _128.y, _39.z);
    float2 _134 = min(_39.xy, (1.0));
    _39 = float3(_134.x, _134.y, _39.z);
    _35 = (-_45__m4) + 1.0;
    _41 = _35 + _39.x;
    _39.x = (-i.Varying_2.y) + i.Varying_2.w;
    _39.x = max(_39.x, 0.0);
    _35 += _39.x;
    _41 = (-_35) + _41;
    _41 = 1.0 / _41;
    ...
    _27.x = (i.Varying_2.w * _27.x) + _33.y;
    _39 = i.Varying_6 + (-i.Varying_7);
    _39 = (_33.xxx * _39) + i.Varying_7;
    _27 = (i.Varying_5 * _27.xxx) + _39;
    _34 = i.Varying_6 * (_45__m0);
    _27 = (_34 * (0.4000000059604644775390625)) + _27;
    _27 = (i.Varying_4 * _33.xxx) + _27;
    _42 = i.Varying_2.x + 1.0;
    _27 = (_27 * (_42)) + (-i.Varying_3);
