Shader "genship/genship_cloud"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // #define _58__m1 _58._m1
            static const matrix _58__m1 = {
            ...
            v2f vert (appdata v)
            {
                ...
                float3 _140 = _25.xyz + (-_58__m3);
                _25 = float4(_140.x, _140.y, _140.z, _25.w);
                // gl_Position = _26;
                ...
                _29.y = 0.5;
                _44.y = 0.5;
                _47 = tex2Dlod(_5, float4(_29, 0.0, 0.0)).x;
                ...
                _50 = 1.0 / _50;
                _44.x = _50 * abs(_35.x);
                _47 = tex2Dlod(_5, float4(_44, 0.0, 0.0)).y;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                _41 = (-_35) + _41;
                _41 = 1.0 / _41;
                float3 _171 = tex2D(_7, i.Varying_0.zw).xyz;
