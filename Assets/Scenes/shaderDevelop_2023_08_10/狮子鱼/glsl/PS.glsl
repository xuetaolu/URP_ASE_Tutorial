...
layout(location = 2) in vec2 _11;
layout(location = 3) in vec2 _12;
layout(location = 0) in vec4 _15;
layout(location = 1) in vec3 _18;
...
void _46()
{
    vec3 _55 = (-_15.xyz) + _32._m1;
    _20 = vec4(_55.x, _55.y, _55.z, _20.w);
    _29 = dot(_20.xyz, _20.xyz);
    _29 = inversesqrt(_29);
    _22.x = dot(_32._m2.xyz, _32._m2.xyz);
    _22.x = inversesqrt(_22.x);
    _22 = _22.xxx * _32._m2.xyz;
    ...
    _20.x = log2(_20.x);
    _27.x = _32._m0.y + _32._m5.y;
    _27.x *= _32._m10;
    _27 = (_27.xx * vec2(0.0, 0.100000001490116119384765625)) + _12;
    _27 = (_27 * _32._m8.xy) + _32._m8.zw;
    _27.x = texture(_7, _27).w;
    _27.y = _27.x * _32._m11;
    _27 *= vec2(_32._m9);
    _29 = (_27.y * 10.0) + 1.0;
    _29 = exp2(_29);
    _20.x *= _29;
    _20.x = exp2(_20.x);
    _23 = _20.xxx * _32._m4.xyz;
    vec3 _215 = _27.xxx * _23;
    _20 = vec4(_215.x, _20.y, _215.y, _215.z);
    vec2 _227 = (_11 * _32._m7.xy) + _32._m7.zw;
    _23 = vec3(_227.x, _227.y, _23.z);
    _24 = texture(_8, _23.xy).xyz;
    _23 = _24 * _32._m6.xyz;
    _22 = _32._m3.xyz + _32._m3.xyz;
    _23 = _22 * _23;
    _25 = (_20.yyy * _32._m4.xyz) + _22;
