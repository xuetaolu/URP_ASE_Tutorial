...
layout(location = 0) in vec4 _21;
layout(location = 1) in vec4 _22;
layout(location = 2) in vec4 _23;
layout(location = 3) in vec4 _24;
layout(location = 0) out vec4 _26;
layout(location = 1) out vec4 _27;
...
void _120()
{
    _31.x = _22.w + _110._m0.x;
    _31.y = _24.w + _110._m0.z;
    vec3 _145 = textureLod(_7, _21.xy, 0.0).xyz;
    ...
    vec3 _161 = _36.xyz * vec3(_110._m21);
    _38 = vec4(_161.x, _161.y, _161.z, _38.w);
    _35 = textureLod(_8, _21.xy, 0.0);
    _44 = lessThan(vec4(0.001000000047497451305389404296875), _35);
    _92 = lessThan(vec4(-1.0), vec4(_110._m29, _110._m30, _110._m29, _110._m30)).xy;
    _92.x = _92.x && _44.x;
    _92.y = _92.y && _44.y;
    if (_92.x)
    {
        _91 = 1.0 / _110._m7;
        _44.x = any(notEqual(vec4(0.0), vec4(_110._m22)));
        _47 = _38.xyz * _110._m14.xyz;
        _47 = mix(_110._m14.xyz, _47, bvec3(_44.x));
        _39 = vec2(_91) * _31;
        _50 = texture(_9, _39);
    ...
    {
        _35.x = 1.0 / _110._m8;
        _52 = any(notEqual(vec4(0.0), vec4(_110._m23)));
        _57 = _38.xyz * _110._m15.xyz;
        _57 = mix(_110._m15.xyz, _57, bvec3(_52));
        _49 = _31 * _35.xx;
        _48 = texture(_10, _49);
    ...
    _63 = lessThan(vec4(-1.0, -1.0, 0.0, 0.0), vec4(_110._m31, _110._m32, _110._m31, _110._m31)).xy;
    _63.x = _44.z && _63.x;
    _63.y = _44.w && _63.y;
    if (_63.x)
    {
        _59.x = 1.0 / _110._m9;
        _93 = any(notEqual(vec4(0.0), vec4(_110._m24)));
        _64 = _38.xyz * _110._m16.xyz;
        _64 = mix(_110._m16.xyz, _64, bvec3(_93));
    ...
    {
        _65.x = 1.0 / _110._m10;
        _85 = any(notEqual(vec4(0.0), vec4(_110._m25)));
        _67 = _38.xyz * _110._m17.xyz;
        _67 = mix(_110._m17.xyz, _67, bvec3(_85));
        _65 = _31 * _65.xx;
        _40 = texture(_12, _65);
    ...
    _68 = textureLod(_13, _21.xy, 0.0).xyz;
    ...
    _77 = lessThan(vec4(-1.0, -1.0, 0.0, 0.0), vec4(_110._m33, _110._m34, _110._m33, _110._m33)).xy;
    _74.x = _74.x && _77.x;
    _74.y = _74.y && _77.y;
    if (_74.x)
    {
        _103 = 1.0 / _110._m11;
        _74.x = any(notEqual(vec4(0.0), vec4(_110._m26)));
        _78 = _38.xyz * _110._m18.xyz;
        _78 = mix(_110._m18.xyz, _78, bvec3(_74.x));
    ...
    {
        _70.x = 1.0 / _110._m12;
        _87 = any(notEqual(vec4(0.0), vec4(_110._m27)));
        _79 = _38.xyz * _110._m19.xyz;
        _79 = mix(_110._m19.xyz, _79, bvec3(_87));
    ...
    {
        _75.x = 1.0 / _110._m13;
        _89 = any(notEqual(vec4(0.0), vec4(_110._m28)));
        vec3 _667 = _38.xyz * _110._m20.xyz;
        _38 = vec4(_667.x, _667.y, _667.z, _38.w);
        vec3 _677 = mix(_110._m20.xyz, _38.xyz, bvec3(_89));
    ...
    if (_77.x)
    {
        _81.x = _22.w;
        _81.y = _24.w;
        _96 = _81.xy * _110._m5.zz;
        vec2 _944 = _81.xy * _110._m6.xx;
        _81 = vec3(_944.x, _944.y, _81.z);
        _38.x = dot(_110._m4.xyz, _110._m4.xyz);
        _38.x = inversesqrt(_38.x);
        vec3 _965 = _38.xxx * _110._m4.xyz;
        ...
        _82.x *= _110._m2.w;
        _82.x = exp2(_82.x);
        _58 = (-_110._m2.xyz) + _110._m3.xyz;
        _82 = (_82.xxx * _58) + _110._m2.xyz;
    ...
    _77.x = any(notEqual(vec4(0.0), vec4(_110._m1)));
...
void main()
{
    ...
    if (_2 != 0u)
    {
        ...
        vec3 _1187 = _26.xyz + _1158;
        _26 = vec4(_1187.x, _1187.y, _1187.z, _26.w);
        vec3 _1196 = round(_26.xyz * _1161) / _1161;
        _26 = vec4(_1196.x, _1196.y, _1196.z, _26.w);
        _1201 = (_2 >> 2u) & 3u;
        switch (_1201)
        {
            case 1u:
        ...
        vec3 _1222 = _27.xyz + _1202;
        _27 = vec4(_1222.x, _1222.y, _1222.z, _27.w);
        vec3 _1231 = round(_27.xyz * _1203) / _1203;
        _27 = vec4(_1231.x, _1231.y, _1231.z, _27.w);
        _1236 = (_2 >> 4u) & 3u;
        switch (_1236)
        {
            case 1u:
        ...
        vec3 _1257 = _28.xyz + _1237;
        _28 = vec4(_1257.x, _1257.y, _1257.z, _28.w);
        vec3 _1266 = round(_28.xyz * _1238) / _1238;
        _28 = vec4(_1266.x, _1266.y, _1266.z, _28.w);
    }
}
