...
//        [HDR]_LightColor ("_LightColor", Color) = (2.92204, 1.56181, 0.57585, 1.62808)
        ...
        [Header(__Caustic__)]
        _FoamLightAddScalar ("_FoamLightAddScalar", Range(0, 1)) = 0.32892
        _FoamLightAddColor ("_FoamLightAddColor", Color) = (0.04413, 0.03476, 0.0106, 1.00)
