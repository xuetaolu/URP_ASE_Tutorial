...
Shader "custom_pbr_aniso"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			UNITY_INSTANCING_BUFFER_START(custom_pbr_aniso)
			...
			UNITY_INSTANCING_BUFFER_END(custom_pbr_aniso)
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float _Matellic_Instance = UNITY_ACCESS_INSTANCED_PROP(custom_pbr_aniso,_Matellic);
				...
				float4 _BaseColor_Instance = UNITY_ACCESS_INSTANCED_PROP(custom_pbr_aniso,_BaseColor);
				...
				float3 f078 = f082;
				float _f90_Instance = UNITY_ACCESS_INSTANCED_PROP(custom_pbr_aniso,_f90);
				...
				float _SmoothnessT_Instance = UNITY_ACCESS_INSTANCED_PROP(custom_pbr_aniso,_SmoothnessT);
				float SmoothnessT57 = _SmoothnessT_Instance;
				float RoughnessT62 = ( 1.0 - SmoothnessT57 );
				float roughnessT5 = RoughnessT62;
				float _SmoothnessB_Instance = UNITY_ACCESS_INSTANCED_PROP(custom_pbr_aniso,_SmoothnessB);
				...
				float TdotH92 = TdotH22;
				float BdotH92 = BdotH23;
				float NdotH92 = NdotH26;
				float roughnessT92 = RoughnessT62;
				float roughnessB92 = RoughnessB63;
				float localD_GGXAniso92 = D_GGXAniso( TdotH92 , BdotH92 , NdotH92 , roughnessT92 , roughnessB92 );
				float D93 = localD_GGXAniso92;
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;7602.396;3356.844;3.873219;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;101;-335.1321,847.7548;Inherit;False;969.2104;514.7421;Comment;7;92;98;97;96;95;94;93;D;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;99;860.9227,-561.1293;Inherit;False;93;D;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-3669.825,-1450.833;Inherit;False;InstancedProperty;_SmoothnessB;SmoothnessB;4;0;Create;True;0;0;0;False;0;False;0.9;0.859;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;25;-2024.788,-562.4752;Inherit;False;17;H;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;55;-3671.638,-1630.554;Inherit;False;InstancedProperty;_SmoothnessT;SmoothnessT;3;0;Create;True;0;0;0;False;0;False;0.1;0.465;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;81;-3710.679,-1214.755;Inherit;False;InstancedProperty;_BaseColor;BaseColor;0;0;Create;True;0;0;0;False;0;False;1,0.782,0.344,0;1,0.7803922,0.3450977,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;131;-3631.172,-784.0566;Inherit;False;InstancedProperty;_Matellic;Matellic;2;0;Create;True;0;0;0;False;0;False;0.9;0.877;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;128;848.4047,252.7875;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;93;410.0784,1033.872;Inherit;False;D;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;163;1179.282,375.4131;Inherit;False;87;F;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.IndirectDiffuseLighting;127;1095.355,250.8197;Inherit;False;World;1;0;FLOAT3;0,0,1;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=3B539B6EAF2167C55774D4BCF2C9234258F79755