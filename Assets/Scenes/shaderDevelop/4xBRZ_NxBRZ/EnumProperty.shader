...
Shader "EnumProperty"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin][KeywordEnum(x2,x4,x6)] _SCALE("SCALE", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color13 = IsGammaSpace() ? float4(0,0,1,0) : float4(0,0,1,0);
				#if defined(_SCALE_X2)
				float4 staticSwitch10 = color11;
				#elif defined(_SCALE_X4)
				float4 staticSwitch10 = color12;
				#elif defined(_SCALE_X6)
				float4 staticSwitch10 = color13;
				#else
				float4 staticSwitch10 = color12;
				#endif
				...
				float3 Color = staticSwitch10.rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
646;348;1746;989;873;491.5;1;True;False
Node;AmplifyShaderEditor.StaticSwitch;10;-38,-21.5;Inherit;False;Property;_SCALE;SCALE;0;0;Create;True;0;0;0;False;0;False;1;1;1;True;;KeywordEnum;3;x2;x4;x6;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;11;-400,-116.5;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;12;-421,139.5;Inherit;False;Constant;_Color1;Color 1;1;0;Create;True;0;0;0;False;0;False;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;13;-214,344.5;Inherit;False;Constant;_Color2;Color 2;1;0;Create;True;0;0;0;False;0;False;0,0,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
