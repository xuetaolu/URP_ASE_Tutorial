	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float temp_output_13_0 = ( 1.0 - distance( (IN.ase_texcoord3.xy*2.0 + -1.0) , float2( 0,0 ) ) );
				float3 temp_cast_0 = (temp_output_13_0).xxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_13_0 = ( 1.0 - distance( (IN.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_13_0 = ( 1.0 - distance( (IN.ase_texcoord.xy*2.0 + -1.0) , float2( 0,0 ) ) );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float temp_output_13_0 = ( 1.0 - distance( (IN.ase_texcoord1.xy*2.0 + -1.0) , float2( 0,0 ) ) );
...
/*ASEBEGIN
Version=18935
258;253;2560;1025;1280;512.5;1;True;False
Node;AmplifyShaderEditor.TexCoordVertexDataNode;10;-710,-78.5;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScaleAndOffsetNode;11;-449,-103.5;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT;2;False;2;FLOAT;-1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DistanceOpNode;12;-189,-90.5;Inherit;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;13;60,-75.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;373,-64;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;16;FillMask;02c48f6cf12f440e8c22c1d6e9d72158;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;True;True;1;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;5;False;-1;5;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638119607922062508;  Blend;0;0;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=9C5A1E66157D53DF4EC692C61514FE5D00353F3B