...
Shader "QuadDrawBall"
{
	Properties
	{
		...
		[ASEEnd]_EdgeSmoothStep("EdgeSmoothStep", Range( 0 , 0.01)) = 0.001
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 temp_output_11_0 = (IN.ase_texcoord3.xy*2.0 + -1.0);
				float dotResult23 = dot( temp_output_11_0 , temp_output_11_0 );
				float4 appendResult25 = (float4(temp_output_11_0 , ( 1.0 - dotResult23 ) , 0.0));
				...
				float3 tanNormal12_g1 = appendResult25.xyz;
				...
				float4 temp_output_42_0_g1 = _BaseColor;
				float length13 = length( temp_output_11_0 );
				float smoothstepResult15 = smoothstep( ( 1.0 - _EdgeSmoothStep ) , ( 1.0 + _EdgeSmoothStep ) , length13);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ( ( ( _MainLightColor * ase_lightAtten ) * max( dotResult14_g1 , 0.0 ) ) + float4( bakedGI34_g1 , 0.0 ) ) * float4( (temp_output_42_0_g1).rgb , 0.0 ) ) * ( 1.0 - smoothstepResult15 ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
1481;391;1440;803;995.3815;993.6083;2.000483;True;False
Node;AmplifyShaderEditor.RegisterLocalVarNode;13;-184.5329,-196.0018;Inherit;False;length;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;28;440.7903,-111.1198;Inherit;False;Lambert Light;2;;1;9be9b95d80559e74dac059ac0a4060cf;0;2;42;COLOR;0,0,0,0;False;52;FLOAT3;0,0,0;False;2;COLOR;0;FLOAT;57
Node;AmplifyShaderEditor.ColorNode;30;142.9705,-229.018;Inherit;False;Property;_BaseColor;BaseColor;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.4103774,0.4103774,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DotProductOpNode;23;-335.2097,45.88016;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;11;-677.0784,-197.0567;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT;2;False;2;FLOAT;-1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LengthOpNode;12;-370.4329,-192.1018;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;10;-925.0783,-191.0567;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;-825.8656,623.8224;Inherit;False;Property;_EdgeSmoothStep;EdgeSmoothStep;1;0;Create;True;0;0;0;False;0;False;0.001;0.00351;0;0.01;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;18;-481.3652,524.9224;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;20;18.07075,404.1405;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;697.7903,49.88016;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;24;-174.2097,32.88016;Inherit;True;2;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;19;-477.4651,684.9224;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;25;172.7903,-16.11984;Inherit;True;FLOAT4;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-669.8651,521.1224;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;14;-810.2653,413.2224;Inherit;False;13;length;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;15;-244.7653,435.3224;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=34D0C08DE2DE3A146447600F71EB0B36C1EC5C88